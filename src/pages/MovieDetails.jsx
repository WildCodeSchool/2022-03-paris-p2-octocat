  ...
  <>
   ...
   <div className="py-4 w-screen">
    <div className="flex items-center justify-center">
     <div
      className="relative w-full h-[40vh] flex justify-center items-center sm:h-[60vh] bg-no-repeat bg-cover top-0"
      style={{ backgroundImage: `url(${imgSrc}` }}
     >
      <button className="absolute" onClick={handleNavigateTrailer}>
       <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-20 w-20 sm:h-40 sm:w-40 opacity-50"
        viewBox="0 0 20 20"
        fill="currentColor"
       >
        <path
    ...
    <div className="pl-3 pt-12 pb-4 sm:flex sm:pl-0 sm:items-start sm:justify-evenly sm:gap-40 sm:w-full ">
     <div className="flex flex-col justify-center sm:w-2/4 sm:pl-20">
      <h1 className="font-bold text-left text-3xl pb-4 sm:text-7xl sm:pl-0 ">
       {movieDetails.original_title
        ? movieDetails.original_title
        : movieDetails.name}
      </h1>
      <h2 className="font-medium text-left text-lg pb-2 sm:text-4xl sm:pl-0 ">
      ...
      <div className="flex pb-2">
       <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-6 w-6"
        fill={movieDetails.vote_average > 2 ? "orange" : "none"}
        viewBox="0 0 24 24"
        stroke="currentColor"
        strokeWidth={2}
       >
       ...
       <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-6 w-6"
        fill={movieDetails.vote_average > 4 ? "orange" : "none"}
        viewBox="0 0 24 24"
        stroke="currentColor"
        strokeWidth={2}
       >
       ...
       <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-6 w-6"
        fill={movieDetails.vote_average > 6 ? "orange" : "none"}
        viewBox="0 0 24 24"
        stroke="currentColor"
        strokeWidth={2}
       >
       ...
       <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-6 w-6"
        fill={movieDetails.vote_average > 8 ? "orange" : "none"}
        viewBox="0 0 24 24"
        stroke="currentColor"
        strokeWidth={2}
       >
       ...
       <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-6 w-6"
        fill={movieDetails.vote_average > 9 ? "orange" : "none"}
        viewBox="0 0 24 24"
        stroke="currentColor"
        strokeWidth={2}
       >
     ...
     <div className="flex flex-col justify-start items-start sm:justify-start sm:w-[30vw] sm:items-start sm:pr-10 sm:pl-18">
      ...
      <div className="flex justify-start items-start pb-10 sm:w-full">
       {movieGenres.length > 0 &&
        movieGenres.map((genre) => (
         <button
          onClick={() => {
           navigate(`/searchpage/${genre.id}`);
          }}
          className="bg-stone-700 px-2 py-2 mr-3 opacity-70"
         >
          {genre.name}
         </button>
        ))}
      ...
      <div className="grid grid-cols-2 gap-4 sm:w-full">
       <div className="font-semibold">
        {movieDetails.first_air_date ? `First air date : ` : `Release date : `}
       </div>
       <div>
       ...
       <div>
        <ul className="flex flex-col">
         {movieCountries.length > 0 &&
          movieCountries.map((country) => <li>{country.name}</li>)}
        </ul>
       </div>
   ...
   <div className="sm:pl-32 pl-3">
    <h2 className="font-large text-left text-md pb-2 sm:text-2xl">
     Add comment
    </h2>
