...
function MovieDetails() {
  return (
    <>
      <Navbar />
        <div className="h-screen py-4 px-4 sm:pl-12 sm:pr-12">
          <div className="sm:w-screen sm:flex sm:justify-center">
              <img alt='poster' src='https://picsum.photos/1200/480'></img>
          </div>
          <div className="sm:flex sm:justify-between sm:w-full py-10">
            <div className="sm:w-2/4">
              <h1 className="font-bold text-center pt-20 text-3xl sm:text-7xl sm:text-left">Movie title</h1>
              <div className="flex">
              ...
              <div className="py-4 sm:w-4/5">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</div>
            </div>
